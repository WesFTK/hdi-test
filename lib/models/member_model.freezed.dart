...
mixin _$MemberModel {
 ...
 String get id; String get name; String get city; DateTime get joinDate; String get membershipStatus;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,city,joinDate,membershipStatus);

@override
String toString() {
  return 'MemberModel(id: $id, name: $name, city: $city, joinDate: $joinDate, membershipStatus: $membershipStatus)';
}
...
@useResult
$Res call({
 String id, String name, String city, DateTime joinDate, String membershipStatus
});
...
/// Create a copy of MemberModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? city = null,Object? joinDate = null,Object? membershipStatus = null,}) {
...
as DateTime,membershipStatus: null == membershipStatus ? _self.membershipStatus : membershipStatus // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String city,  DateTime joinDate,  String membershipStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MemberModel() when $default != null:
return $default(_that.id,_that.name,_that.city,_that.joinDate,_that.membershipStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String city,  DateTime joinDate,  String membershipStatus)  $default,) {final _that = this;
switch (_that) {
case _MemberModel():
return $default(_that.id,_that.name,_that.city,_that.joinDate,_that.membershipStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String city,  DateTime joinDate,  String membershipStatus)?  $default,) {final _that = this;
switch (_that) {
case _MemberModel() when $default != null:
return $default(_that.id,_that.name,_that.city,_that.joinDate,_that.membershipStatus);case _:
  return null;
...
class _MemberModel implements MemberModel {
  const _MemberModel({required this.id, required this.name, required this.city, required this.joinDate, required this.membershipStatus});
...
/// Create a copy of MemberModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? city = null,Object? joinDate = null,Object? membershipStatus = null,}) {
